...
<ol>
  ...
  <li>**DO NOT TOUCH *STYLES.CSS* FILE**</li>
</ol>
...
<ol>
  <li>Create 6 new HTML elements with 6 **different** `transform` properties</li>
  <li>Add a 5 stage keyframe animation</li>
  <li>Use the shorthand `animation` property to assign it an element</li>
  <li>Create a button with 5 different styles that change upon **hover**</li>
  ...
  <li>Make your hover transitions *smooth* (hint: `transition`)</li>
</ol>
